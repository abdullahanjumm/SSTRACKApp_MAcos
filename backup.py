...
import objc
from Cocoa import (
    NSWindow, NSImageView, NSImage, NSApplication, NSButton,
    NSRunningApplication, NSApplicationActivateIgnoringOtherApps,
    NSColor, NSFont, NSView, NSMakeRect
)
...
# Create a rounded button
    ...
    def open_settings(self):
        ...
        title_label = tk.Label(
            header_frame, text="Settings", font=("Arial", 10), bg="#0E4772"
        )
        ...
        def on_enter(event):
            close_button["background"] = "#0E4772"  # Red on hover
        ...
        tk.Label(
            settings_popup, text="User Settings", font=title_font, bg="#0E4772"
        ...
        # Auto-pause tracking
        tk.Label(
            settings_popup, text="Auto-pause tracking:", font=label_font, bg="#0E4772"
        ...
        # Weekly time limit
        tk.Label(
            settings_popup, text="Weekly time limit:", font=label_font, bg="#0E4772"
        ...
        tk.Label(
            settings_popup, text="Yes", font=label_font, fg="#4CAF50", bg="#0E4772"
        ).grid(row=6, column=3, padx=5, pady=2, sticky="w")

        # App & URL tracking
        tk.Label(
            settings_popup, text="App & URL tracking:", font=label_font, bg="#0E4772"
    ...
    def logout(self):
        ...
        # Destroy current GUIApp window
        self.root.destroy()
    
        # Relaunch the login screen in the same process
